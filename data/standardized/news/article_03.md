---
title: "Guideline for Program Change Request"
...
- Is not currently a first-year or final-year student (applies for Change of Degree/College)[[1]](https://policy.vinuni.edu.vn/all-policies/guideline-for-program-change-request/#_ftn1).
...
[[1]](https://policy.vinuni.edu.vn/all-policies/guideline-for-program-change-request/#_ftnref1) In accordance with MOET’s guideline
### 4.2 Timelines

#### Submit the request between: 1 July – 15 August
- **Normally processed by:** At least one week before the first day of the course registration period for the next semester.
- **Effective semester:** Fall semester

#### Submit the request between: 1 November – January 15
- **Normally processed by:** Spring semester
**Note:**
...
#### Step: 1
- **Responsibility:** Student / Academic Advisor
- **Workflow:** Make a request for program change ([FRM06](https://vinuniversity.sharepoint.com/sites/OfficeofRegistrar/SitePages/Registry-Service-Forms.aspx))
- **Time:** Start 1 July or 1 November annually
...
- In case, the student has come up with the final decision, the student needs to fill in the form FRM06 (<https://vinuni.edu.vn/registrar/registry-service-forms/>) and send it back to the Registrar office (soft copy or hard copy with signatures).
...
- **Workflow:** Preliminary Check (eligibility criteria)
- If **Yes** : Continue
- If **No** : Inform Student

#### Step: 2 working days since receiving the student’s request.
...
#### Step: 3
- **Responsibility:** Dean or delegate
- **Workflow:** Review student’s application/ request
- **Time:** 5 working days since receiving the application from Registrar
...
#### Step: 
- **Responsibility:** Dean or delegate Student
- **Workflow:** Conduct an interview with the student (optional)
- **Time:** 5 working days since receiving the application from Registrar
...
(*) _Most of all, students need to be clearly informed that they may have to take extra courses for the remaining semesters or may have to take extra semesters to complete all the degree requirements._  |

#### Step: 5
- **Responsibility:** College Dean Registrar
- **Workflow:** Approve
- **Time:** 2 working days since the completion of application review/interview
...
#### Step: 6
- **Responsibility:** Registrar
- **Workflow:** Endorse the formal decision
- **Time:** 2 working days since receiving the final approval
- Provost to endorse the decision (based on Dean’s proposal).

#### Step: 7
- **Responsibility:** Registrar
- **Workflow:** Inform students and related departments for the change
- **Time:** 2 working days since releasing the formal decision
