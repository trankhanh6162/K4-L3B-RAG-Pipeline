...
_For example: For Academic Year 2026–2027, May 15, 2026 is the official validity cut-off date for all admission rounds. Test results obtained before May 15, 2024 will not be accepted, regardless of the test provider’s stated validity period._

#### Record: 1
- **English language proficiency tests:** International English Language Testing System (IELTS) Academic module
- **Minimum required scores:** An overall score of 6.5, with no individual band score lower than 6.0. One Skill Retake results are accepted subject to standard validity requirements; updated results must be submitted by August 30 of the admission year. Note: IELTS General Training module tests are not currently accepted.

#### Record: 2
- **English language proficiency tests:** Test of English as a Foreign Language – internet-based test (TOEFL iBT)
...
#### Record: 3
- **English language proficiency tests:** Pearson Test of English (PTE Academic)
- **Minimum required scores:** An overall score of 58 with no communicative skills scores less than 50.

#### Record: 4
- **English language proficiency tests:** Cambridge English Qualifications (using the Cambridge English Scale)
- **Minimum required scores:** An overall score of 176 with no skill below 169 in any Component. Accepted tests: · C1 Advanced (formerly known as CAE) or · C2 Proficiency (formerly known as CPE) or · Linguaskill (New and enhanced Linguaskill effective April 2025 taken in person at a recognized test center)

#### Record: 6
- **English language proficiency tests:** Vietnamese Standardized Test of English Proficiency (VSTEP)
- **Minimum required scores:** Result is equivalent to VSTEP Level 5 C1 level.
**Note:**
...
#### Category: VinCore course regisrtation
- **Group 1 — IELTS 6.0 (no skill below 6.0) or equivalent:** All Colleges
- **Group 2 — IELTS 6.5+ with no more than one skill below 6.0:** 1. Agile Innovation
2. Healthy Lifestyle
3. HASS1041 (delivered in Vietnamese)  | 1. Agile Innovation
2. Healthy Lifestyle
...
#### Category: Major course registration
- **Group 1 — IELTS 6.0 (no skill below 6.0) or equivalent:** CBM
- **Group 2 — IELTS 6.5+ with no more than one skill below 6.0:** No major courses permitted

#### Category: CHS (MD)
- **Group 1 — IELTS 6.0 (no skill below 6.0) or equivalent:** Not applicable

#### Category: CHS (BN)
- **Group 1 — IELTS 6.0 (no skill below 6.0) or equivalent:** All major courses permitted
- **Group 2 — IELTS 6.5+ with no more than one skill below 6.0:** All major courses permitted

#### Category: CAS
- **Group 1 — IELTS 6.0 (no skill below 6.0) or equivalent:** First-Year Seminar course only
- **Group 2 — IELTS 6.5+ with no more than one skill below 6.0:** – All major courses of BA in Psycology and BA in Economics permitted – Only major courses permitted for BA in Multi Communication should be: * COMM1010 Introduction to Communication * COMM2021 Communication Modalities
...
#### Step: Initial Application Check
- **Responsible Unit:** Admissions Office
- **Role:** Verify English proficiency evidence upon submission
- **Deadline:** Submission Deadline for Applicants. At latest, one week before the start of instruction
- **Platform/Portal:** Admissions Portal

#### Step: Evidence Verification (English language proficiency tests)
- **Responsible Unit:** Registrar Office For special cases, the Registrar may seek consultation from the College of Arts and Sciences (English Department) for additional guidance and evaluation
- **Role:** Verify and authenticate submitted evidence
- **Deadline:** Within 2 weeks before the first day of move-in
- **Platform/Portal:** Admissions Portal/Verification System (if any)
